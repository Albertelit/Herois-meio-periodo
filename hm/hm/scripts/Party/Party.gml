...

{
	...
	explosao : // sim eu sei, e meio paia, mas deixa funfar primeiro e dps troco
	{
		name : "voltagem [4]", //1
        description : "{0} Eletrecuta!",
        subMenu : "Magic",
...
global.party_ma = [
	{
		...
		actions: [global.actionLibrary.attack, global.actionLibrary.Taser, global.actionLibrary.explosao]
		},
...
global.party = [
	{
		...
		perigo: 4, //não esqueça que os personagens vão ter perigo para serem focados
		sprites: {idle: spr_AronD, attack: spr_AronD, defend: spr_EmmaD, down: spr_EmmaL},
		actions: [global.actionLibrary.attack,  global.actionLibrary.explosao]
		},
